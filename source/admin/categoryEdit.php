...
if(strlen($_SESSION['alogin'])==0) {   
    ...
    if(isset($_POST['update'])) {
        ...
        updateCategory($catid, $category, $status);
...
<head>
    ...
    <title>Catalog | Edit Categories</title>
...
<?php 
$catid = intval($_GET['catid']);
$results = getCategoryValues($catid);
...
<input class="form-control" type="text" name="category" value="<?php echo htmlentities($result->Name);?>" maxlength="150" required />
</div>
<div class="form-group">
<label>Status</label>
