...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities(getCondition($result->ConditionId));?></td>
                                            <td class="center"><?php echo htmlentities(getStatus($result->StatusId));?></td>
                                            <td class="center"><?php echo htmlentities(getOwner($result->OwnerId));?></td>
